...
LOG = ROOT / 'real_estate_approaches' / 'scripts' / 'mondrian_conformal_indiv_log.txt'
...
p_val = np.load(OUT_DIR / 'val_proba_diana_m2_fe_plus_indiv.npy').astype(np.float32)
p_test = np.load(OUT_DIR / 'test_proba_diana_m2_fe_plus_indiv.npy').astype(np.float32)
